 ...
 * @property {(number[]|number)} [namespaces=0] Array of namespace ids or a single namespace id, see more: {@link http://community.fandom.com/wiki/Help:Namespaces Help:Namespaces}
 ...
 * @property {(number[]|number)} [namespaces] Array of namespace ids or a single namespace id, see more: {@link http://community.wikia.com/wiki/Help:Namespaces Help:Namespaces}
