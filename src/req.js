 ...
 * @property {number | number[]} [namespaces] Array of namespace ids or a single namespace id, see: {@link http://community.fandom.com/wiki/Help:Namespaces Help:Namespaces}
